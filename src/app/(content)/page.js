            ...
            <div className="max-w-7xl relative mx-auto">
              <div className="z-20 max-w-7xl mx-auto p-4 relative flex flex-col justify-center items-center gap-8">
                ...
                <div className="text-center text-slate-300 text-base md:text-lg font-normal leading-relaxed">
                  Are you ready to embark on an extraordinary journey through
                  the cosmos?
                </div>
            ...
            <div className=" flex-col items-start w-fit lg:gap-[13px] gap-8 inline-flex ">
              ...
              <div className="md:w-[580px] md:h-[281px] flex-col justify-start items-start gap-[21px] inline-flex">
                ...
                <div className="md:w-[580px] text-slate-300 text-lg font-normal leading-relaxed">
                  ...
                  unparalleled immersion and realism. Every experience is
                  tailored to your unique interests and needs, ensuring that you
                  have a truly personalized journey through space. Whether
                  you're a space enthusiast, a student of astrophysics, or
                  simply curious about the cosmos, SpaceVerse has something
                  incredible to offer.
                </div>
              </div>
              <div className="gradient-box z-20">
            ...
            <div className=" flex-col items-start w-fit lg:gap-[13px] gap-8 inline-flex ">
              ...
              <div className="md:w-[580px] md:h-[281px] flex-col justify-start items-start gap-[21px] inline-flex">
                ...
                <div className="md:w-[580px] text-slate-300 text-lg font-normal leading-relaxed">
                  ...
                  effortlessly access the wonders of space anytime, anywhere,
                  and share this unparalleled, incredible journey with friends,
            ...
            <div className="relative flex-col items-start w-fit lg:gap-[13px] gap-8 inline-flex ">
              ...
              <div className="md:w-[580px] md:h-[281px] flex-col justify-start items-start gap-[21px] inline-flex">
                ...
                <div className="md:w-[580px] text-slate-300 text-lg font-normal leading-relaxed">
                  ...
                  been thoughtfully designed and curated. Dive into this
                  universe, a masterpiece crafted by our singular 'Astral
                  Architect,' endeavoring to make the wonders of space more
                  accessible and closer to our souls.
                </div>
              </div>
              <div className="gradient-box z-20">
                <button
            ...
            <div className="xl:w-[635.63px] xl:h-[300px] max-w-fit justify-center items-start sm:items-start lg:items-start  lg:gap-[21.37px] xl:flex-row flex flex-col md:w-full lg:ml-1">
              ...
              <div className="lg:w-auto md:w-[580px] flex-col justify-start items-start  gap-[21px] inline-flex">
                ...
                <div className=" text-slate-300 lg:text-sm font-normal leading-[21px]">
                  Maria Bruna is a Space Engineer with a lifelong passion for
                  space, dating back to her early years. She has worked as an AI
                  specialist, contributing to a $300ARR space company from 2013
                  to 2018, and co-founded a VR startup for astronauts.
                </div>
                <div className=" justify-start items-start gap-[17.96px] inline-flex">
                  <div className="justify-center items-center cursor-pointer z-20 flex">
                    <a
                      href="https://www.linkedin.com/company/spaceverseai"
                      target="_blank"
